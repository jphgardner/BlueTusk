...
export class GraphPage {
  ...
  protected readonly models = [
    ...
    },
    {
      ...
      status: 'V1 preview code-ready',
      stage: 'gate-passed',
      body: 'Consume committed change transactions into checkpointed application graph projections.',
      route: '/documentation/real-time/continuous-graph',
      rows: [
        { label: 'Source', value: 'Streams transactions' },
        { label: 'Execution', value: 'Incremental projection' },
        { label: 'Availability', value: 'Dependency release chain gated' },
      ],
    },
  ] as const;
