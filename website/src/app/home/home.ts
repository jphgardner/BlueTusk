...
export class Home {
  ...
  protected readonly products = [
    ...
    },
    {
      ...
      icon: 'extension',
      description:
        'First-party packages for PostGIS, pgvector, TimescaleDB, pg_durable, citext, hstore, ltree, and pg_trgm.',
      status: 'V1 code-ready',
      statusKind: 'complete',
      tone: 'amber',
      route: '/extensions',
  ...
  protected readonly paths = [
    ...
    },
    {
      ...
      body: 'Register PostGIS, pgvector, TimescaleDB, pg_durable, citext, hstore, ltree, or pg_trgm before building the data source.',
      route: '/extensions',
      action: 'Browse Extensions',
      proof: '8 package families',
    },
    {
      id: 'graph',
      icon: 'share',
