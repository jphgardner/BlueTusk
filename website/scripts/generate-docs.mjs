...
const llmsIndex =
  ...
  'Use this index to find the canonical HTML documentation. The complete source-synchronised handbook is available at [llms-full.txt](https://bluetusk.io/llms-full.txt).\n\n' +
  '## Start here\n\n' +
...
const llmsFull =
  '# BlueTusk complete documentation\n\n' +
  '> Source-synchronised documentation for the BlueTusk PostgreSQL platform for .NET.\n\n' +
