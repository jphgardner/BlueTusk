...
- EF Core CRUD, transactions, generated values, core LINQ, advanced PostgreSQL index, declarative partition, and row-level-security migrations/scaffolding, typed PostgreSQL
