...
- an immutable data-source feature registry plus independently packaged,
  live-tested PostGIS ADO.NET/NetTopologySuite EF, TimescaleDB, `citext` ADO.NET/EF, `hstore`, `ltree`, `pg_trgm`, and pgvector ADO.NET/EF previews.
