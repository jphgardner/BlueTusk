...
- EF Core CRUD, transactions, generated values, core LINQ, advanced PostgreSQL index and declarative partition migrations/scaffolding, typed PostgreSQL
