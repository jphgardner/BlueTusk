...
- EF Core CRUD, transactions, generated values, core LINQ, advanced PostgreSQL index, declarative partition, row-level-security, and direct table-inheritance migrations/scaffolding, typed PostgreSQL
