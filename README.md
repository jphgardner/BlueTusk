...
- EF Core CRUD, transactions, generated values, core LINQ, advanced PostgreSQL index, declarative partition, row-level-security, direct table-inheritance, and enum/domain/composite-type migrations/scaffolding, typed PostgreSQL
