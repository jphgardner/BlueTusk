...
- an immutable data-source feature registry plus independently packaged,
  live-tested PostGIS, `citext` ADO.NET/EF, `hstore`, `ltree`, `pg_trgm`, and dense pgvector ADO.NET previews.
