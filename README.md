...
- an immutable data-source feature registry plus independently packaged,
  live-tested `citext` ADO.NET/EF, `hstore`, and dense pgvector ADO.NET previews.
