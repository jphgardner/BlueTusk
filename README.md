...
- EF Core CRUD, transactions, generated values, core LINQ, advanced PostgreSQL index, declarative partition, row-level-security, direct table-inheritance, enum/domain/composite-type, and function/procedure migrations/scaffolding, typed PostgreSQL
