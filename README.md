...
- an immutable data-source feature registry plus independently packaged,
  live-tested `citext` ADO.NET/EF, `hstore`, `ltree`, and dense pgvector ADO.NET previews.
