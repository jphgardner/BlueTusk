...
The pgvector package has its own opt-in PostgreSQL 18 service and live gate:
...
- an immutable data-source feature registry plus independently packaged,
  live-tested `citext` ADO.NET/EF and dense pgvector ADO.NET previews.
