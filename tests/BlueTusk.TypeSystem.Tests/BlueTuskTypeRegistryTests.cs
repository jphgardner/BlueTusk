...
public sealed class BlueTuskTypeRegistryTests
{
    ...
    [InlineData(603, "box", typeof(BlueTuskBox), typeof(BlueTuskBoxCodec))]
    [InlineData(604, "polygon", typeof(BlueTuskPolygon), typeof(BlueTuskPolygonCodec))]
    [InlineData(628, "line", typeof(BlueTuskLine), typeof(BlueTuskLineCodec))]
    [InlineData(650, "cidr", typeof(BlueTuskNetworkAddress), typeof(BlueTuskCidrCodec))]
    ...
    [InlineData(718, "circle", typeof(BlueTuskCircle), typeof(BlueTuskCircleCodec))]
