...
public sealed class SyncApiFreezeTests
{
    [Fact]
    public void Every_sync_public_api_baseline_matches_the_candidate_freeze()
    {
        var repositoryRoot = FindRepositoryRoot();
        var manifestPath = Path.Combine(repositoryRoot, "eng", "sync-api-freeze.json");
        ...
        var discovered = Directory
            ...
            .Where(path => Path
                ...
                .StartsWith("BlueTusk.Sync", StringComparison.Ordinal))
